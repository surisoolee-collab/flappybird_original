...
class Jerry(pygame.sprtie.Sprite):
     def __init__(self):
         super().__init__()
         self.jerry_alive = pygame.image.load("images/jerry.png").convert_alpha()
         self.jerry_alive = pygame.transform.scale(self.jerry_alive, (45, 45))
         self.jerry_dead = pygame.image.load("images/deadjerry.png").convert_alpha()
         self.jerry_dead = pygame.transform.scale(self.jerry_dead, (45, 45))
